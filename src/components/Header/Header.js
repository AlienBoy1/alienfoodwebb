...
function Header() {
  ...
  return (
    <header className="sticky top-0 inset-x-0 z-30 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 glassmorphism px-6 md:block hidden border-b border-gray-200 dark:border-gray-700">
