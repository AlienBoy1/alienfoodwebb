...
function Banner() {
  ...
  return (
    <div className="px-3 sm:px-6 relative heightFix mb-12 sm:mb-24">
        ...
        <div className="flex lg:justify-between lg:items-center overflow-hidden p-0.5 lg:flex-row flex-col lg:gap-4 gap-8">
          <Fade left>
            <div className="main_heading">
              <h3 className="font-medium sm:text-xl mb-3 text-base ">¿Tienes hambre?</h3>
              ...
              <div className="flex items-center xl:mt-12 lg:mt-10 sm:mt-8 mt-6 gap-3 sm:gap-4 flex-wrap">
                <button className="button text-sm sm:text-base xl:px-16 px-8 sm:px-14 py-2 sm:py-2.5" onClick={orderNow}>
                  Ordenar Ahora
                </button>
                <button className="xl:px-16 lg:text-base text-sm sm:text-base button-ghost px-8 sm:px-14 py-2 sm:py-2.5" onClick={viewMore}>
                  Ver Más
                </button>
              </div>
            </div>
