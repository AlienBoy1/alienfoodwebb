...
function Menu({ dishes, categories }) {
  // Asegurar que dishes y categories siempre sean arrays
  ...
  return (
    <div className="w-full py-12 sm:py-20 px-4 sm:px-6 bg-gray-100 dark:bg-gray-900 mt-10" id="menu">
      <h2 className="heading lg:mb-32 sm:mb-28 mb-20  mt-4">Explora Nuestro Mejor Menú</h2>
